...
const VisualCalm: React.FC = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-start px-4 py-10 sm:px-6 sm:py-14 md:min-h-screen md:justify-center md:py-20">
      <div className="relative w-full max-w-6xl group rounded-3xl overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] transition-all duration-700 hover:scale-[1.01]">
        <img 
          ...
          className="w-full aspect-[16/9] sm:aspect-[16/10] md:aspect-video object-cover grayscale-[0.3] group-hover:grayscale-0 transition-all duration-1000"
